...
stop_attenuation_entry.place(relx=0.6, rely=0.2, anchor=tk.CENTER)
...
transition_band_entry.place(relx=0.6, rely=0.3, anchor=tk.CENTER)
...
Mini_frequency_entry.place(relx=0.6, rely=0.4, anchor=tk.CENTER)
...
Max_frequency_entry.place(relx=0.6, rely=0.5, anchor=tk.CENTER)
...
NewFs_entry.place(relx=0.6, rely=0.6, anchor=tk.CENTER)
...
CutoffFrequency_entry.place(relx=0.6, rely=0.7, anchor=tk.CENTER)
